...
Committees can spend money to elect or defeat candidates independently of their campaigns; such activities are called independent expenditures and are {specifically reported to the F.E.C.}[http://www.fec.gov/finance/disclosure/ie_reports.shtml]. The target(s) of the expenditures is included in the reports, so to retrieve recent IEs about a specific candidate, use that candidate's ID:
