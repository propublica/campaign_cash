...
As with Candidate.search, the results of Committee.search return a subset of all Committee attributes. The full Committee object includes the most recent financial summary data available, plus the other election cycles that the committee is registered in dating back to 1980. Some committees have a sponsor, which could be a corporation, association or candidate.

To fetch the details for a single committee in a cycle:

  Committee.find("C00326389", 2012)
  #=> #<CampaignCash::Committee:0x101bb8440 @name="SNAKE RIVER SUGAR COMPANY POLITICAL ACTION COMMITTEE", @state="ID", @party="", @candidate_loans=nil, @super_pac=false, @total_receipts=30363.3, @date_coverage_from="2011-01-01", @debts_owed=nil, @address="1951 SOUTH SATURN WAY", @leadership=false, @total_from_pacs=nil, @other_cycles=[2010, 2008, 2006, 2004, 2002, 2000, 1998], @date_coverage_to="2011-11-30", @total_refunds=nil, @city="BOISE", @total_from_individuals=30363.3, @id="C00326389", @sponsor_name=nil, @end_cash=16845.2, @fec_uri="http://query.nictusa.com/cgi-bin/dcdev/forms/C00326389/", @total_disbursements=46500.0, @total_contributions=30363.3, @zip="83709", @candidate_id=nil, @begin_cash=32981.9>
